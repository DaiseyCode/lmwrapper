...
def test_batch_starting():
    ...
    sample_file_resp = {'id': 'file-mockid', 'bytes': 272, 'created_at': 1718670611, 'filename': 'upload', 'object': 'file', 'purpose': 'batch', 'status': 'processed', 'status_details': None}
    ...
    mock_batch_data = {'id': 'batch_mockbatch', 'completion_window': '24h', 'created_at': 1718670788, 'endpoint': '/v1/completions', 'input_file_id': 'file-mockid', 'object': 'batch', 'status': 'validating', 'cancelled_at': None, 'cancelling_at': None, 'completed_at': None, 'error_file_id': None, 'errors': None, 'expired_at': None, 'expires_at': 1718757188, 'failed_at': None, 'finalizing_at': None, 'in_progress_at': None, 'metadata': None, 'output_file_id': None, 'request_counts': {'completed': 0, 'failed': 0, 'total': 0}}
